...
To build tests for N1SDP using the same process as described in :ref:`Build`,
you only need to add ``meta-ewaol-config/kas/tests.yml`` to the kas build
command:
